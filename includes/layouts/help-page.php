...
<div class="wrap" style="font-size: 16px;">
    ...
    <p style="width: 70%;">
    <?php _e('This plugin allows you to create price lists and easily embed them to your content with shortcodes.
    ...
    <table class="widefat" style="width: 70%">
        ...
        <tr>
            ...
            <td class="row-title"><?php _e('Get desired price list by its title', 'plp-domain') ?></td>
        </tr>
        <tr>
            <td class="row-title" style="text-align: center; vertical-align: middle;">list_slug</td>
            <td class="row-title"><?php _e('Get desired price list by its slug. It is more safe way to query a price list,
                because you can change the price list title while editing it, but not the slug!', 'plp-domain') ?></td>
        </tr>
        <tr>
            <td class="row-title" style="text-align: center; vertical-align: middle;">list_id</td>
            <td class="row-title"><?php _e('Get the price list by its id.
                Not very handy but you can be sure that you will get exactly the same post you want!', 'plp-domain') ?></td>
        </tr>
        <tr>
            <td class="row-title" style="text-align: center; vertical-align: middle;">per_page</td>
            <td class="row-title"><?php _e('Choose the amount of rows to display in price list.
                Pagination will be automatically enabled if amounts of goods
                exceeds the amount of rows to display per page', 'plp-domain') ?></td>
        </tr>
        <tr>
            <td class="row-title" style="text-align: center; vertical-align: middle;">theme</td>
            <td class="row-title"><?php _e('Price list visual representation.
                You can choose between "green-circle" and "red-circle" for this moment', 'plp-domain') ?></td>
        </tr>
        </tbody>
    </table>
</div>